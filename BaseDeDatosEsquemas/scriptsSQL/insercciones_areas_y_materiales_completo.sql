...
INSERT INTO materiales (tipo_de_material_id, digito_5, digito_6, nombre_del_material, descripcion) VALUES
(7,1,9,'BANCO DE MADERA','BANCO DE MADERA'),
(4,1,6,'COMPUTADORA DELL','COMPUTADORA DELL'),
(4,2,6,'TELÉFONO','TELÉFONO'),
(4,2,0,'PLÓTER','PLÓTER'),
(4,1,9,'IMPRESORA','IMPRESORA'),
(7,2,0,'ESTANTE','ESTANTE'),
(7,2,4,'LIBRERO','LIBRERO'),
(3,8,3,'DESTORNILLADOR INALÁMBRICO','DESTORNILLADOR INALÁMBRICO'),
(4,7,3,'JUEGO DE BOCINAS','JUEGO DE BOCINAS'),
(2,9,1,'BOTAS INDUSTRIALES','BOTAS INDUSTRIALES'),
(3,4,3,'JUEGO DE LLAVES ALLEN (MÉTRICA/ESTÁNDAR)','JUEGO DE LLAVES ALLEN (MÉTRICA/ESTÁNDAR)'),
(3,4,4,'PINZAS DE PUNTA/CORTE','PINZAS DE PUNTA/CORTE'),
(3,4,5,'PINZAS DE CHOFER','PINZAS DE CHOFER'),
(3,4,6,'PINZAS DE ELECTRICISTA','PINZAS DE ELECTRICISTA'),
(3,4,7,'LLAVE DE AJUSTE','LLAVE DE AJUSTE'),
(3,4,8,'PINZAS DE PRESIÓN','PINZAS DE PRESIÓN'),
(3,8,4,'(JUEGO DE LLAVES) LLAVE 18mm','(JUEGO DE LLAVES) LLAVE 18mm'),
(3,9,0,'EXTENCION','EXTENCION'),
(5,1,4,'PRESENTADOR','PRESENTADOR'),
(1,3,4,'ODÓMETRO PRETUL','ODÓMETRO PRETUL'),
(5,9,9,'BIN AMARILLO MEDIANO','BIN AMARILLO MEDIANO'),
(4,1,7,'IMPRESORA 3D','IMPRESORA 3D'),
(4,1,8,'MULTIFUNCIONAL','MULTIFUNCIONAL');